...
<div className="fixed h-full inset-0 z-[1000] w-full font-poppins items-center justify-center bg-transparent backdrop-blur-sm bg-opacity-25">
  <div className="h-full mt-0 pt-0 w-full flex justify-center items-center">
    <div className=" relative grid gap-8 mt-0 dark:bg-gray-900">
    <RxCross2 size={30} className='absolute top-0 right-0 cursor-pointer' style={{color:"white"}} onClick={()=>{onClose()}} />
